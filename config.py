...
OWNER_USERNAME = getenv("OWNER_USERNAME","RANA_YOUR_FATHER")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "Ranamusicxbot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "RANA X MUSIC")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "rana_assistant")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Rana012s/New-repo-codes",
)
